...
/**
 * Util-class to enable a list to be rearrangeble. Use in a custom CellFactory
 * and @Override the updateItem while still calling the super.updateItem().
 *
 * @author Daniel
 */
public class ListCellX<T> extends ListCell<T> implements ChangeListener<Number> {
	...
	public void updateItem(T item, boolean empty) {
		...
		if (item != null) {
			...
			if (item.getClass() == Activity.class) {
				switch (((Activity) item).getType()) {
